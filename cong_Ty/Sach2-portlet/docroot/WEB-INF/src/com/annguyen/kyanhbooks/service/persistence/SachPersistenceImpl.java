...
import com.annguyen.kyanhbooks.NoSuchSachException;
import com.annguyen.kyanhbooks.model.Sach;
import com.annguyen.kyanhbooks.model.impl.SachImpl;
import com.annguyen.kyanhbooks.model.impl.SachModelImpl;
...
public class SachPersistenceImpl extends BasePersistenceImpl<Sach>
	 ...
	 */
	@Override
	public Sach create(String MaSach) {
		Sach sach = new SachImpl();

		sach.setNew(true);
		sach.setPrimaryKey(MaSach);
	...
	public Sach remove(String MaSach)
		...
		return remove((Serializable)MaSach);
	}
	...
	@Override
	public Sach updateImpl(com.annguyen.kyanhbooks.model.Sach sach)
	...
	protected Sach toUnwrappedModel(Sach sach) {
		...
		sachImpl.setDonGia(sach.getDonGia());
		sachImpl.setSoLuong(sach.getSoLuong());
		sachImpl.setUrlHinh(sach.getUrlHinh());
		sachImpl.setNoiDung(sach.getNoiDung());
		sachImpl.setTacGia(sach.getTacGia());
		sachImpl.setNamXB(sach.getNamXB());
		sachImpl.setNXB(sach.getNXB());
		sachImpl.setMaLoaiSach(sach.getMaLoaiSach());
	 ...
	 */
	@Override
	public Sach findByPrimaryKey(String MaSach)
		throws NoSuchSachException, SystemException {
		return findByPrimaryKey((Serializable)MaSach);
	}
	 ...
	 */
	@Override
	public Sach fetchByPrimaryKey(String MaSach) throws SystemException {
		return fetchByPrimaryKey((Serializable)MaSach);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.annguyen.kyanhbooks.model.Sach")));
