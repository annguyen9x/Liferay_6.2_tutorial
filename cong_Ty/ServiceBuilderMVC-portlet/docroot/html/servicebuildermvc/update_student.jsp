...
<br />
<%
	if (SessionMessages.contains(renderRequest.getPortletSession(),
			"student-update-success")) {
%>
<liferay-ui:success key="student-update-success"
	message="Selected student information have been update successfully." />
<%
	}
%>
<%
...
<liferay-ui:error key="student-update-error"
	message="There is an Error occurred while updating student please try again" />
<%
	}
%>
<%
	List<Student> studentList = StudentLocalServiceUtil.getStudents(0,
...
<%for(Student student:studentList){%>
  <option value="<%=student.getStudentId()%>" <%=selecteStudentObject!=null&&selecteStudentObject.getStudentId()==
student.getStudentId()?"selected":""%>><%=student.getStudentId()%></option>
  <%} %>
</select><br>
...
<b>Gender</b><br/>
<input type="radio" name="<portlet:namespace/>studentGender"
...
<b>Address</b><br/>
<textarea rows="4" cols="50" name="<portlet:namespace/>studentAddress">
