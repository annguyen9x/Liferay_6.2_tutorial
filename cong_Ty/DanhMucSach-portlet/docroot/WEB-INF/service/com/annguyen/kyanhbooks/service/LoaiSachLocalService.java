...
/**
 * Provides the local service interface for LoaiSach. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author AnNguyen
 * @see LoaiSachLocalServiceUtil
...
public interface LoaiSachLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoaiSachLocalServiceUtil} to access the loai sach local service. Add custom service methods to {@link com.annguyen.kyanhbooks.service.impl.LoaiSachLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
