...
public class StudentWrapper implements Student, ModelWrapper<Student> {
	...
	*/
	...
	@Override
	public int compareTo(com.liferay.tutorial.model.Student student) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.liferay.tutorial.model.Student> toCacheModel() {
		return _student.toCacheModel();
	}

	@Override
	public com.liferay.tutorial.model.Student toEscapedModel() {
		return new StudentWrapper(_student.toEscapedModel());
	}

	@Override
	public com.liferay.tutorial.model.Student toUnescapedModel() {
