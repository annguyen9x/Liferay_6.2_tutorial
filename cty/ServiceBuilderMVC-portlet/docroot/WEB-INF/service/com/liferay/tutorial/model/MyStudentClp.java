...
public class MyStudentClp extends BaseModelImpl<MyStudent> implements MyStudent {
	...
	public void setFirstName(String firstName) {
		...
		if (_myStudentRemoteModel != null) {
			try {
				...
				method.invoke(_myStudentRemoteModel, firstName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setLastName(String lastName) {
		...
		if (_myStudentRemoteModel != null) {
			try {
				...
				method.invoke(_myStudentRemoteModel, lastName);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStudentAge(int studentAge) {
		...
		if (_myStudentRemoteModel != null) {
			try {
				...
				method.invoke(_myStudentRemoteModel, studentAge);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStudentGender(int studentGender) {
		...
		if (_myStudentRemoteModel != null) {
			try {
				...
				method.invoke(_myStudentRemoteModel, studentGender);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setStudentAddress(String studentAddress) {
		...
		if (_myStudentRemoteModel != null) {
			try {
				...
				method.invoke(_myStudentRemoteModel, studentAddress);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public int compareTo(MyStudent myStudent) {
		...
		if (getStudentId() < myStudent.getStudentId()) {
			value = -1;
		}
		else if (getStudentId() > myStudent.getStudentId()) {
			value = 1;
		}
		else {
			value = 0;
